...
export default function VideoPage() {
  ...
  return (
    <div className="flex-1 flex flex-col p-6">
      <h1 className="text-xl font-semibold text-slate-800 mb-2">Video Calls</h1>
      <p className="text-slate-600 text-sm mb-6">Allow camera and microphone access to enable video calls.</p>
      ...
      <p className="mt-6 text-slate-500 text-sm">Video calls are coming soon. Check back later.</p>
    </div>
  );
}
